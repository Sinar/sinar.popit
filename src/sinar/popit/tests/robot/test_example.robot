...
#
#  $ bin/test -s sinar.popit -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src sinar.popit.testing.SINAR_POPIT_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/sinar/popit/tests/robot/test_example.robot
#
